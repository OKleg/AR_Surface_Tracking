...
public class PackageSpawner : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (lockedPlane != null)
        {
           ...
           // sourse.text = (int.Parse(sourse.text)+1).ToString();
            //Debug.Log($"Text changed: {sourse.text}");
            packageScale.Set(packageScale.x, packageScale.y * 2f, packageScale.z);
